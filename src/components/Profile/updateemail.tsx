    ...
    Update your Email Address
        ...
        <div className="p-6 space-y-4">
          ...
          <div>
            ...
            style={{ fontWeight: WEIGHT.four, color: COLORS.grey }}>Current Email:</label>
           ...
           <div>
            <label className={`text-sm text-gray-300 ${FONTSIZE[14]}`}
            style={{ fontWeight: WEIGHT.four, color: COLORS.grey }}>New Email Address *</label>
            <div className="relative mt-1">
              <input
           ...
           <div>
            <label className={`text-sm text-gray-300 ${FONTSIZE[14]}`}
            style={{ fontWeight: WEIGHT.four, color: COLORS.grey }}>Confirm Email Address *</label>
            <div className="relative mt-1">
              <input
          ...
          <div>
            <label className={`text-sm text-gray-300 ${FONTSIZE[14]}`}
            style={{ fontWeight: WEIGHT.four, color: COLORS.grey }}> Password (for Verification) *</label>
            <div className="relative mt-1">
              <input
          ...
          <div className="bg-[#F0B1001A] border border-[#FDC7004D] rounded-lg p-3 text-xs text-gray-400">
             ...
             <div className={`flex items-center gap-1  text-[#FDC700]  ${FONTSIZE[14]}`}
            style={{ fontWeight: WEIGHT.four }}>
     <TriangleAlert color="#FDC700"  size={15}/>
     Important:
    </div>
            <div className={`list-disc ml-4 space-y-1 ${FONTSIZE[12]}`}
            style={{ fontWeight: WEIGHT.four, color: COLORS.grey }}>
             <p>A verification emailwill be sent to your new email address. you'll need to verifyit before the change takes effect</p>
            </div>
          </div>
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button className={`flex-1 py-2 justify-between cursor-pointer rounded-lg bg-linear-to-r from-[#2B7FFF] to-[#0092B8] text-white font-medium hover:opacity-90 transition ${FONTSIZE[16]}`}
            style={{ fontWeight: WEIGHT.seven, color: COLORS.primary_white }}>
             ✔ Update Email
            </button>
          </div>
